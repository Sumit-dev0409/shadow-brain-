// Brain Shadow — DeepSeek Popup Script

const PLATFORM_URL = 'chat.deepseek.com';
const BASE_URL     = 'https://chat.deepseek.com';
const EXTRA_WAIT   = 2500;
const EXPORT_NAME  = 'brain_shadow_deepseek';
...
async function loadStats() {
  ...
  ['deepseek','chatgpt','claude','gemini','blackbox','copilot'].forEach(p => {
