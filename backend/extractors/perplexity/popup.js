// Brain Shadow — Perplexity Popup Script

const PLATFORM_URL = 'perplexity.ai';
const BASE_URL     = 'https://www.perplexity.ai';
const EXTRA_WAIT   = 2000;
const EXPORT_NAME  = 'brain_shadow_perplexity';
...
async function loadStats() {
  ...
  ['perplexity','chatgpt','claude','gemini','deepseek','grok'].forEach(p => {
