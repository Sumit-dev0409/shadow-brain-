...
const CATEGORY_LABELS = ["Claude AI", "Copilot", "ChatGPT", "Gemini", "Grok", "DeepSeek", "Perplexity", "BackBox"];
const CATEGORY_COLORS = ["#f97316", "#8b5cf6", "#ffffff", "#3b82f6", "#facc15", "#3ddc97", "#fb7185", "#b87333"];
