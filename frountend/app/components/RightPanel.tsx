...
import { Search, X, Clock, Sparkles, ChevronRight } from "lucide-react";
...
export interface SearchRecord {
  ...
  firstAt: number;         // timestamp of first search
  lastAt: number;          // timestamp of most recent search
}
          ...
          {showMsg && selectedRecord && (
            ...
            >
              ...
              <p className="text-[11px] leading-relaxed" style={{ color: "var(--text-secondary)" }}>
                You&apos;ve explored this topic <strong style={{ color: "var(--text-primary)" }}>{selectedRecord.count}×</strong> — first{" "}
